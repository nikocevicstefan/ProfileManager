...
@section('content')
    ...
    <div class="card" style="background: #dbebfb">
        <div class="card-body">
            <form autocomplete="off" method="POST" action="/person/edit/{{$person->id}}">
                {{csrf_field()}}
                <div class="row">
                    <div class="form-group col-6">
                        <h6>Name:</h6>
                        <input class="form-control" type="text" value="{{$person->name}}" name="name" required>
                    </div>

                    <div class="form-group col-6">
                        <h6>Surname:</h6>
                        <input class="form-control" type="text" value="{{$person->surname}}" name="surname" required>
                    </div>
                </div>
                <div class="row">
                    <div class="form-group col-6">
                    ...
                    <div class="form-group col-6">
                        <h6>Age:</h6>
                        <input class="form-control" type="text" value="{{$person->age}}" name="age" required>
                    </div>
                </div>

                <div class="form-group">
                    <h6>JMBG:</h6>
                    <input class="form-control" type="text" value="{{$person->JMBG}}" name="JMBG" required>
                </div>

                <div class="row">
                    <div class="form-group col-6">
                        <h6>Place of birth</h6>
                        <input class="form-control" type="text" value="{{$person->place_of_birth}}" name="place_of_birth" required>
                    </div>

                    <div class="form-group col-6">
                        <h6>Country</h6>
                        <input class="form-control" type="text" value="{{$person->country}}" name="country" required>
                    </div>
                </div>
                ...
                <div class="row">
                    <div class="form-group col-6">
                        <h6>City</h6>
                        <input class="form-control" type="text" value="{{$person->city}}" name="city" required>
                    </div>

                    <div class="form-group col-6">
                        <h6>Address</h6>
                        <input class="form-control" type="text" value="{{$person->address}}" name="address" required>
                    </div>
                </div>
